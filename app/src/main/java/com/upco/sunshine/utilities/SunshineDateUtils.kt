...
/**
 * Object for handling date conversions that are useful for Sunshine.
 */
object SunshineDateUtils {
    ...
    fun getNormalizedUtcMsForToday(): Long {
         ...
         * into this method so it can determine changes to account for daylight saving us.
         */
    ...
    fun getFriendlyDateString(context: Context, normalizedUtcMidnight: Long, showFullDate: Boolean): String {
        ...
        /*
         * As basis for comparison, we use the number of days that have passed from the epoch
         * until today.
         */
        ...
        if (daysFromEpochToProvidedDate == daysFromEpochToToday || showFullDate) {
            ...
            return DateUtils.formatDateTime(context, localDate, flags).capitalize()
        }
    }
    ...
    /**
     * This method returns the number of days since the epoch
     * (January 01, 1970, 12:00 Midnight UTC) in the UTC time from the current date.
     *
    ...
    private fun getDayName(context: Context, dateInMillis: Long): String {
        ...
        return when (daysAfterToday) {
            ...
            1 -> context.getString(R.string.tomorrow)
                ...
                return dayFormat.format(dateInMillis).capitalize()
            }
        }
    }
